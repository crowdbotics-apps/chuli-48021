"""
Django settings for chuli_48021 project.
...
WSGI_APPLICATION = 'chuli_48021.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chuli_48021 API",
    "DESCRIPTION": "API documentation for chuli_48021 App",
    "VERSION": "v1",
}
